# ZEVORA Hybrid AI Agent Design System
...
**Project:** ZEVORA Hybrid AI Agent
**Category:** AI Agent / Developer Operations
...
- Show routing, provider, model, and execution location as concise technical status, not decorative content.
- Distinguish on-device work from cloud fallback with local/cloud indicators and explicit labels.
- Streaming, loading, approval, success, and failure states must keep stable dimensions and preserve nearby controls.
- Tool execution and filesystem mutation require clear review states; destructive actions use the muted red semantic treatment.
- Cost and token information uses the technical font and tabular numerals.
